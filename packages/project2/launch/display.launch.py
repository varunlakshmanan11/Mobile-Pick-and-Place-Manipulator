...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'project2.urdf'
    xacro_file = "project2.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "project2"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("project2"), "rviz", "display_default.rviz"]
    )
